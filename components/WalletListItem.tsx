...
const WalletListItem = ({ item, index, router }: { index: WalletType, index: number, router: Router }) => {
        ...
        <Animated.View entering={FadeInDown.delay(index * 500).springify().damping(13)}>
            <TouchableOpacity style={styles.container} onPress={openWallet}>
                ...
                <View style={styles.imageConatiner}>
                    <Image style={{ flex: 1 }} source={item?.image} transition={100} contentFit='cover' />
                </View>
